    ...
    <section id="hero-01" className="w-full max-w-screen-xl mx-auto flex flex-col gap-12 sm:gap-16 lg:gap-20">
      ...
      <div className="flex flex-col gap-4 amd:gap-12 text-left md:text-center px-6 md:px-24 xl:px-32 pt-16 md:pt-24 lg:pt-32">
        ...
        <div className="w-full flex flex-col md:flex-row justify-center mt-4 md:mt-8 mb-8 gap-4">
          <a href="https://drive.google.com/file/d/1CeGoDrBmn3fuKrosrYWWr7gu_38t1xLZ/view?usp=drive_link" className="bg-transparent hover:bg-orange-800 border-2 border-orange-800/70 font-sans font-bold tracking-0wider text-xs text-orange-800 hover:text-stone-100 uppercase px-4 py-3 rounded-full transition duration-200" target="_blank">Curriculum Vitae</a>
